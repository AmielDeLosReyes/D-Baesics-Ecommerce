...
<html lang="en">
  ...
  <body class="index layout2">
	...
	<div class="container">
				<div class="header-left float-left d-inline-block float-xs-right float-lg-left">
					<div class="logo">
												<a href="index.html"><img src="img/logos/logo-02.png" alt="NatureCircle"></a>		</div>		
		...
		<div class="ttheader-service float-none d-inline-block align-top">avtumu offer ends soon!</div>
		...
		<div>
			<div><a href="my-account.html" class="text-capitalize">my account</a></div>
			<div><a href="#" class="modal-view button" data-toggle="modal" data-target="#modalRegisterForm">Register</a></div>
			<div><a href="#" class="modal-view button" data-toggle="modal" data-target="#modalLoginForm">login</a></div>
						<div class="language-wrapper toggle">
				<button type="button" class="btn text-capitalize dropdown-toggle"><img src="img/banner/en.png" alt="en"/><span>language</span></button>
				...
				<button type="button" class="btn text-capitalize dropdown-toggle"><span>currency</span></button>
	  ...
	  <div class="slider-wrapper my-40 my-sm-25 float-left w-100">
		<div class="ttloading-bg"></div>
	  	<div class="slider slider-for owl-carousel">
			<div>
				<a href="#">
					<img src="img/slider/sample-03.jpg" alt=""/>
				</a>
			...
			<div>
				<a href="#">
					<img src="img/slider/sample-04.jpg" alt=""/>
				</a>
				...
				<div class="inner-category owl-carousel">
						...
						<div class="tt_cat_content">
							<div class="category-img left-block">
								<a href="#" class="ttcategoy-image">
									<img src="img/category/01.jpg" alt="collection-img"/>
								</a>
							</div>
					...
					<div class="ttproduct-cat-item">
						<div class="tt_cat_content">
							<div class="category-img left-block">
								<a href="#" class="ttcategoy-image">
									<img src="img/category/02.jpg" alt="collection-img"/>
								</a>
							</div>
							<div class="description right-block text-center">
					...
					<div class="ttproduct-cat-item">
						<div class="tt_cat_content">
							<div class="category-img left-block">
								<a href="#" class="ttcategoy-image">
									<img src="img/category/03.jpg" alt="collection-img"/>
								</a>
							</div>
							<div class="description right-block text-center">
					...
					<div class="ttproduct-cat-item">
						<div class="tt_cat_content">
							<div class="category-img left-block">
								<a href="#" class="ttcategoy-image">
									<img src="img/category/04.jpg" alt="collection-img"/>
								</a>
							</div>
							<div class="description right-block text-center">
						...
						<div class="ttfeatured-content products grid owl-carousel" id="owl1">
								...
								<div class="product-thumb">
									<div class="image fade-hover">
										<a href="product-details.html">
											...
											<img src="img/products/04.jpg" alt="04" class="second_image img-responsive"/>										</a>
										<div class="button-wrapper">
										<div class="button-group text-center">
											<button type="button" class="btn btn-primary btn-cart" data-target="#cart-pop" data-toggle="modal"><i class="material-icons">shopping_cart</i><span>Add to cart</span></button>
											<a href="wishlist.html" class="btn btn-primary btn-wishlist"><i class="material-icons">favorite</i><span>wishlist</span></a>
								...
								<div class="product-thumb">
									<div class="image fade-hover">
										<a href="product-details.html">
											...
											<img src="img/products/05.jpg" alt="05" class="second_image img-responsive"/>										</a>
										<div class="button-wrapper">
										<div class="button-group text-center">
											<button type="button" class="btn btn-primary btn-cart" data-target="#cart-pop" data-toggle="modal"><i class="material-icons">shopping_cart</i><span>Add to cart</span></button>
											<a href="wishlist.html" class="btn btn-primary btn-wishlist"><i class="material-icons">favorite</i><span>wishlist</span></a>
								...
								<div class="product-thumb">
									<div class="image fade-hover">
										<a href="product-details.html">
											...
											<img src="img/products/06.jpg" alt="06" class="second_image img-responsive"/>										</a>
										<div class="button-wrapper">
										<div class="button-group text-center">
											<button type="button" class="btn btn-primary btn-cart" data-target="#cart-pop" data-toggle="modal"><i class="material-icons">shopping_cart</i><span>Add to cart</span></button>
											<a href="wishlist.html" class="btn btn-primary btn-wishlist"><i class="material-icons">favorite</i><span>wishlist</span></a>
								...
								<div class="product-thumb">
									<div class="image fade-hover">
										<a href="product-details.html">
											...
											<img src="img/products/07.jpg" alt="07" class="second_image img-responsive"/>										</a>
										<div class="button-wrapper">
										<div class="button-group text-center">
											<button type="button" class="btn btn-primary btn-cart" data-target="#cart-pop" data-toggle="modal"><i class="material-icons">shopping_cart</i><span>Add to cart</span></button>
											<a href="wishlist.html" class="btn btn-primary btn-wishlist"><i class="material-icons">favorite</i><span>wishlist</span></a>
								...
								<div class="product-thumb">
									<div class="image fade-hover">
										<a href="product-details.html">
											...
											<img src="img/products/08.jpg" alt="08" class="second_image img-responsive"/>										</a>
										<div class="button-wrapper">
										<div class="button-group text-center">
											<button type="button" class="btn btn-primary btn-cart" data-target="#cart-pop" data-toggle="modal" disabled="disabled"><i class="material-icons">shopping_cart</i><span>Add to cart</span></button>
											<a href="wishlist.html" class="btn btn-primary btn-wishlist"><i class="material-icons">favorite</i><span>wishlist</span></a>
							...
							<div class="product-layouts">
								<div class="product-thumb">
									<div class="image fade-hover">
										<a href="product-details.html">
											<img src="img/products/08.jpg" alt="03"/>
											<img src="img/products/09.jpg" alt="09" class="second_image img-responsive"/>										</a>
										<div class="button-wrapper">
										<div class="button-group text-center">
											<button type="button" class="btn btn-primary btn-cart" data-target="#cart-pop" data-toggle="modal"><i class="material-icons">shopping_cart</i><span>Add to cart</span></button>
											<a href="wishlist.html" class="btn btn-primary btn-wishlist"><i class="material-icons">favorite</i><span>wishlist</span></a>
  ...
  <div class="ttbannerblock container">
    <div class="row">
      <div class="ttbanner1 ttbanner col-sm-6 col-xs-6">
        <div class="ttbanner-img"><a href="#"><img src="img/banner/cms-03.jpg" alt="cms-03"></a></div>
      ...
      <div class="ttbanner2 ttbanner col-sm-6">
        <div class="ttbanner-img"><a href="#"><img src="img/banner/cms-04.jpg" alt="cms-04"></a></div>
        <div class="ttbanner-inner">
          <div class="ttbanner-desc text-center">
			...
			<div id="ttsmartblog" class="my-40 my-sm-25 bottom-to-top hb-animate-element">
				...
				<div class="smartblog-content owl-carousel">
					...
					<div class="item">
						<div class="ttblog_image_holder">
							<a href="#">
								<img src="img/banner/blog-03.jpg" alt="blog-03">							</a>
																<span class="blogicons">
					...
					<div class="item">
						<div class="ttblog_image_holder">
							<a href="#">
								<img src="img/banner/blog-04.jpg" alt="blog-04">							</a>
								<span class="blogicons">
					...
					<div class="item">
						<div class="ttblog_image_holder">
							<a href="#">
								<img src="img/banner/blog-05.jpg" alt="blog-05">							</a>
								<span class="blogicons">
