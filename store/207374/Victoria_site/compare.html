            ...
            <div class="table-responsive">
              <table class="table compare-info">
                <tbody>
                  ...
                  <tr>
                      <td>Summary</td>
                      <td class="ttdescription">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque elementum lacinia justo convallis ornare.</td>
                      <td class="ttdescription">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque elementum lacinia justo convallis ornare.</td>
                  </tr>
                  <tr>
                      <td>Weight</td>
                ...
                <tbody><tr>
                  ...
                  <td>
                    ...
                    <button class="btn btn-secondary" type="button" title="Remove">Remove</button>
                  </td>
                  <td>
                    <button type="button" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
                    <button class="btn btn-secondary" type="button" title="Remove">Remove</button>
